    ...
    ReentrancyGuardUpgradeable 
{
    ...
    // --- INITIALIZER (Runs once on deploy) ---
    ...
    // ==========================================
    // 1️⃣ GENERATE RANDOM CODE (K9X2M)
    // ==========================================
    ...
    function _generateRandomString() internal view returns (string memory) {
        ...
        // Create pseudo-randomness from timestamp + user address
    ...
    // ==========================================
    // 2️⃣ ZAP IN (Accepts String Code)
    // ==========================================
    function zapIn(uint256 _amount, string memory _referrerCode) external nonReentrant {
        ...
        // 1. Lookup Referrer Address from the Code string
        address referrerAddr = codeToAddress[_referrerCode];
        
        // 2. Validation: If code is invalid or self-referral, set referrer to 0
